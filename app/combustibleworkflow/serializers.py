...
class CombustibleWorkflowSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if not isinstance(instance, CombustibleWorkflow):
            raise serializers.ValidationError('Instance is not of type CombustibleWorkflow.')
...
class CombustibleDocumentSerializer(serializers.ModelSerializer):
    class Meta:
