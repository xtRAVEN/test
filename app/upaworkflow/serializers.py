...
class AutorisationUrbanismeWorkflowSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if not isinstance(instance, AutorisationUrbanismeWorkflow):
            raise serializers.ValidationError('Instance is not of type AutorisationUrbanismeWorkflow.')
